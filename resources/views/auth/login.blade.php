                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                <div class="brand-logo pb-5">
                                    <a href="html/index.html" class="logo-link">
                                        <img class="logo-light logo-img logo-img-lg" src="{{ asset('assets/admin/assets/images/logo.png') }}" srcset="{{ asset('assets/admin/assets/images/logo2x.png 2x') }}" alt="logo">
                                        <img class="logo-dark logo-img logo-img-lg" src="{{ asset('assets/admin/assets/images/logo-dark.png') }}" srcset="{{ asset('assets/admin/assets/images/logo-dark2x.png 2x') }}" alt="logo-dark">
                                    </a>
                                </div>
                                ...
                                <form method="POST" action="{{ route('login') }}" class="form-validate is-alter" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input autocomplete="off"  id="email" type="email" name="email" class="form-control form-control-lg" required  placeholder="Enter your email address or username">
                                        </div>
                                    </div><!-- .form-group -->
                                    <div class="form-group">
                                        <div class="form-label-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input autocomplete="new-password" id="password" type="password" name="password" class="form-control form-control-lg" required  placeholder="Enter your passcode">
                                        </div>
                                    </div><!-- .form-group -->
                                    <div class="form-group">
